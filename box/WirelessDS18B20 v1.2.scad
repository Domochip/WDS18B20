...
module makeBase(width, depth, height, rounding, minimum, side, bottom, mdiameter, mheight, gap) {
    ...
    union(){
        difference() {
            ...
            //WirelessDS18B20 bornier Cutout
            //bornier2
            ...
            //bornier3
            translate([-width/2,1+4/2,bottom+4/*4mm from bottom*/])cube([(width-iwidth)/2,4,6]);
            translate([-width/2,-4/2,bottom+4/*4mm from bottom*/])cube([(width-iwidth)/2,4,6]);     
            translate([-width/2,-4-2-1,bottom+4/*4mm from bottom*/])cube([(width-iwidth)/2,4,6]);
            ...
            //bornier3
            translate([-width/2+0.5,0,1])rotate([90,0,-90])linear_extrude(0.6)text(text="1WIRE",font="Liberation Sans:style=Bold",size=3.5,halign="center");
            translate([-width/2+0.5,-8.4,10.2])rotate([90,0,-90])linear_extrude(0.6)text(text="-",font="Liberation Sans:style=Bold",size=5.5,halign="center");
            translate([-width/2+0.5,0,12])rotate([90,0,-90])linear_extrude(0.6)text(text="DATA",font="Liberation Sans:style=Bold",size=2.2,halign="center");
            translate([-width/2+0.5,8.4,9.7])rotate([90,0,-90])linear_extrude(0.6)text(text="+",font="Liberation Sans:style=Bold",size=5.5,halign="center");

        }

        //WirelessDS18B20 additions
        translate([-iwidth/2,-idepth/2,bottom])linear_extrude(2)polygon([[0,0],[0,3.5],[3.5,0]]);
        translate([-iwidth/2,idepth/2,bottom])linear_extrude(2)polygon([[0,0],[0,-3.5],[3.5,0]]);
...
module makeLid(width, depth, rounding, minimum, side, bottom, mdiameter, mheight, gap, overlap) {
	...
	difference() {
        ...
        //bornier3
        translate([+_pcbX/2-3.3,5,0])cylinder(d=4.5,h=bottom);
        translate([+_pcbX/2-3.3,0,0])cylinder(d=4.5,h=bottom);
        translate([+_pcbX/2-3.3,-5,0])cylinder(d=4.5,h=bottom);
        ...
        */
        ...
        //Brand :-)
        translate([5,0,0.5])rotate([0,-180,-90])difference(){
            linear_extrude(0.6)offset(r=0.7)text(text="WirelessDS18B20",font="Liberation Sans:style=Bold",size=2.4,halign="center");
            linear_extrude(0.6)text(text="WirelessDS18B20",font="Liberation Sans:style=Bold",size=2.4,halign="center");
        }
        /*translate([2,-13,0.5])rotate([0,-180,-90])difference(){
            linear_extrude(0.6)offset(r=0.7)text(text="By DomoChip",font="Liberation Sans:style=Bold",size=2.4,halign="left");
            linear_extrude(0.6)text(text="By DomoChip",font="Liberation Sans:style=Bold",size=2.4,halign="left");
        }*/
        ...
        //translate([-1.5,-5.5,0.5])rotate([0,-180,-180])linear_extrude(0.6)text(text="By DomoChip",font="Liberation Sans:style=Bold",size=2.4,halign="left");
	}
